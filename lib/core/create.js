...
const createCommands = () => {
  ...
  program
    .command('addcpn <name>')
    .description(
      'add vue component, 例如: anzhiyu addcpn HelloWorld [-d src/components]'
    )
    .action(name => {
  ...
  program
    ...
    .description(
      'add vue page and router config, 例如: anzhiyu addpage Home [-d src/pages]'
    )
    .action(page => {
  ...
  program
    ...
    .description(
      'add vue3.0 page, 例如: anzhiyu add3page role [-d src/views/main/system/role]'
    )
    .action(vue3page => {
